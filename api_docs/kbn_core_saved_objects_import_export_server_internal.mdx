...
####
id: kibKbnCoreSavedObjectsImportExportServerInternalPluginApi
slug: /kibana-dev-docs/api/kbn-core-saved-objects-import-export-server-internal
...
### Classes
<DocDefinitionList data={kbnCoreSavedObjectsImportExportServerInternalObj.server.classes}/>
