...
####
id: kibKbnCoreUsageDataServerInternalPluginApi
slug: /kibana-dev-docs/api/kbn-core-usage-data-server-internal
...
### Classes
<DocDefinitionList data={kbnCoreUsageDataServerInternalObj.server.classes}/>
