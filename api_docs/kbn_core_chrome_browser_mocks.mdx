...
####
id: kibKbnCoreChromeBrowserMocksPluginApi
slug: /kibana-dev-docs/api/kbn-core-chrome-browser-mocks
...
### Objects
<DocDefinitionList data={kbnCoreChromeBrowserMocksObj.common.objects}/>
