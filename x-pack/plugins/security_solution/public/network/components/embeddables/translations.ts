...
export const EMBEDDABLE_HEADER_HELP = i18n.translate(
  'xpack.securitySolution.components.embeddables.embeddedMap.embeddableHeaderHelp',
  {
...
export const DESTINATION_LAYER = i18n.translate(
  'xpack.securitySolution.components.embeddables.embeddedMap.destinationLayerLabel',
  {
...
export const CLIENT_LAYER = i18n.translate(
  'xpack.securitySolution.components.embeddables.embeddedMap.clientLayerLabel',
  {
...
export const LINE_LAYER = i18n.translate(
  'xpack.securitySolution.components.embeddables.embeddedMap.lineLayerLabel',
  {
    defaultMessage: 'Line',
  }
);
...
export const ERROR_TITLE = i18n.translate(
  'xpack.securitySolution.components.embeddables.indexPatternsMissingPrompt.errorTitle',
  {
...
export const MAP_TOOL_TIP_ERROR = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.errorTitle',
  {
...
export const MAP_TOOL_TIP_FEATURES_FOOTER = (currentFeature: number, totalFeatures: number) =>
  i18n.translate('xpack.securitySolution.components.embeddables.mapToolTip.footerLabel', {
...
export const SOURCE_IP = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.pointContent.sourceIPTitle',
  {
...
export const DESTINATION_IP = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.pointContent.destinationIPTitle',
  {
...
export const SERVER_IP = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.pointContent.serverIPTitle',
  {
...
export const SOURCE_DOMAIN = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.pointContent.sourceDomainTitle',
  {
...
export const DESTINATION_DOMAIN = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.pointContent.destinationDomainTitle',
  {
...
export const CLIENT_DOMAIN = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.pointContent.clientDomainTitle',
  {
...
export const SERVER_DOMAIN = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.pointContent.serverDomainTitle',
  {
...
export const LOCATION = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.pointContent.locationTitle',
  {
...
export const ASN = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.pointContent.asnTitle',
  {
    defaultMessage: 'ASN',
  }
);
...
export const SOURCE = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.lineContent.sourceLabel',
  {
...
export const DESTINATION = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.lineContent.destinationLabel',
  {
...
export const CLIENT = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.lineContent.clientLabel',
  {
...
export const SERVER = i18n.translate(
  'xpack.securitySolution.components.embeddables.mapToolTip.lineContent.serverLabel',
  {
