...
import type { NetworkHttpStrategyResponse } from '../../../../common/search_strategy';

export const mockData: NetworkHttpStrategyResponse = {
  edges: [
    {
      node: {
  ...
  totalCount: 4,
  rawResponse: {} as NetworkHttpStrategyResponse['rawResponse'],
};
