          ...
          <EuiText size="s">
            <p>
              <FormattedMessage
                ...
                defaultMessage="We'll save your integration with our recommended defaults. You can change this later by editing the Elastic Defend integration within your agent policy."
              />
            </p>
          </EuiText>
        </EuiCallOut>
