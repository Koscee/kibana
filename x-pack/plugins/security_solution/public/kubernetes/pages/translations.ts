...
export const COLUMN_NODE = i18n.translate('xpack.securitySolution.kubernetes.columnNode', {
  defaultMessage: 'Node',
});
...
export const COLUMN_CONTAINER = i18n.translate(
  'xpack.securitySolution.kubernetes.columnContainer',
  {
    defaultMessage: 'Container',
  }
);
export const COLUMN_POD = i18n.translate('xpack.securitySolution.kubernetes.columnPod', {
  defaultMessage: 'Pod',
});
