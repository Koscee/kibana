 ...
 */
export class SOReferenceExtractor {
  constructor(private readonly fieldsToExtract: Field[]) {}
  ...
  public populateFieldsFromReferences<T extends object>(data: SavedObject<object>): SavedObject<T> {
    ...
    return dataToManipulate as SavedObject<T>;
  }
  ...
  public populateFieldsFromReferencesForPatch<T extends object>({
    ...
    return dataToManipulate as SavedObjectsUpdateResponse<T>;
  }
}
