            ...
            events: [
              ...
              },
              {
                ...
                fields: {
                  ...
                  'ecs.version': ['1.5.0'],
                  'destination.address': ['10.128.0.57'],
                  'destination.port': [3389],
                  'destination.bytes': [1681],
                  'destination.ip': ['10.128.0.57'],
                  'source.address': ['142.202.189.139'],
                  'source.port': [16151],
                  'source.bytes': [1224],
                  'source.ip': ['142.202.189.139'],
                  ...
                  'host.mac': ['42:01:0a:80:00:39'],
                  'host.architecture': ['x86_64'],
                  'event.sequence': [3293864],
                  'event.ingested': ['2021-02-08T21:57:26.417451347Z'],
                  'event.created': ['2021-02-08T21:50:28.5553532Z'],
                  'event.kind': ['event'],
                  'event.module': ['endpoint'],
                  'event.action': ['disconnect_received'],
                  'event.id': ['LzzWB9jjGmCwGMvk++++FG/L'],
